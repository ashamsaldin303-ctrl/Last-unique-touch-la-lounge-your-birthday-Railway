...
async function main() {
  ...
  const products = [
    // ===== CHAIRS (5) =====
    {
      ...
      images: ['/products/louis-ghost-chair.png'],
    ...
    },
    {
      ...
      images: ['/products/chivari-chair-gold.png'],
      stock: 100,
      categoryId: chairs.id,
    },
    {
      ...
      images: ['/products/tiffany-chair-crystal.png'],
      model3dUrl: 'procedural-chair',
      stock: 80,
      categoryId: chairs.id,
    },
    {
      ...
      images: ['/products/monet-armchair.png'],
      stock: 30,
      categoryId: chairs.id,
    },
    {
      ...
      images: ['/products/bombon-chair-velvet.png'],
      stock: 0,
      categoryId: chairs.id,
    },
    ...
    // ===== TABLES (5) =====
    {
      ...
      images: ['/products/round-banquet-table.png'],
      stock: 20,
    ...
    },
    {
      ...
      rentalPricePerDay: 4.0,
      securityDeposit: 12.0,
      images: ['/products/cocktail-highboy-table.png'],
      stock: 40,
      categoryId: tables.id,
    },
    {
      ...
      images: ['/products/marble-coffee-table.png'],
    ...
    },
    {
      ...
      images: ['/products/dining-table-12-seater.png'],
      stock: 10,
      categoryId: tables.id,
    },
    {
      ...
      rentalPricePerDay: 3.5,
      securityDeposit: 10.0,
      images: ['/products/gold-side-table.png'],
      stock: 25,
      categoryId: tables.id,
    },
    ...
    // ===== LIGHTING (5) =====
    {
      ...
      images: ['/products/crystal-chandelier.png'],
    ...
    },
    {
      ...
      securityDeposit: 8.0,
      images: ['/products/led-uplighter.png'],
      stock: 60,
      categoryId: lighting.id,
    },
    {
      ...
      images: ['/products/industrial-pendant-light.png'],
      stock: 35,
      categoryId: lighting.id,
    },
    {
      ...
      securityDeposit: 18.0,
      images: ['/products/brass-lantern.png'],
      stock: 45,
      categoryId: lighting.id,
    },
    {
      ...
      images: ['/products/gold-floor-lamp.png'],
  ...
  const laLoungeProducts = [
    {
      ...
      rentalPricePerDay: 8,
      securityDeposit: 20,
      images: ['/products/lalounge_modern.webp'],
      stock: 100,
      isActive: true,
  ...
  const birthdayProducts = [
    {
      ...
      securityDeposit: 100,
      images: ['/products/birthday_atelier.webp'],
      stock: 20,
      isActive: true,
