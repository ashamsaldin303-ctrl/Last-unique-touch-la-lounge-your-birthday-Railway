...
async function main() {
  ...
  const products = [
    // ===== CHAIRS (5) =====
    {
      ...
      images: JSON.stringify(['/products/louis-ghost-chair.png', '/products/chivari-chair-gold.png', '/products/tiffany-chair-crystal.png']),
    ...
    },
    {
      ...
      images: JSON.stringify(['/products/chivari-chair-gold.png', '/products/louis-ghost-chair.png', '/products/monet-armchair.png']),
      stock: 100,
      categoryId: chairs.id,
    },
    {
      ...
      images: JSON.stringify(['/products/tiffany-chair-crystal.png', '/products/louis-ghost-chair.png', '/products/bombon-chair-velvet.png']),
      model3dUrl: 'procedural-chair',
      stock: 80,
      categoryId: chairs.id,
    },
    {
      ...
      images: JSON.stringify(['/products/monet-armchair.png', '/products/bombon-chair-velvet.png', '/products/chivari-chair-gold.png']),
      stock: 30,
      categoryId: chairs.id,
    },
    {
      ...
      images: JSON.stringify(['/products/bombon-chair-velvet.png', '/products/monet-armchair.png', '/products/tiffany-chair-crystal.png']),
      stock: 0,
      categoryId: chairs.id,
    },
    ...
    // ===== TABLES (5) =====
    {
      ...
      images: JSON.stringify(['/products/round-banquet-table.png', '/products/dining-table-12-seater.png', '/products/marble-coffee-table.png']),
      stock: 20,
    ...
    },
    {
      ...
      rentalPricePerDay: 4.0,
      securityDeposit: 12.0,
      images: JSON.stringify(['/products/cocktail-highboy-table.png', '/products/gold-side-table.png', '/products/round-banquet-table.png']),
      stock: 40,
      categoryId: tables.id,
    },
    {
      ...
      images: JSON.stringify(['/products/marble-coffee-table.png', '/products/gold-side-table.png', '/products/cocktail-highboy-table.png']),
    ...
    },
    {
      ...
      images: JSON.stringify(['/products/dining-table-12-seater.png', '/products/round-banquet-table.png', '/products/marble-coffee-table.png']),
      stock: 10,
      categoryId: tables.id,
    },
    {
      ...
      rentalPricePerDay: 3.5,
      securityDeposit: 10.0,
      images: JSON.stringify(['/products/gold-side-table.png', '/products/marble-coffee-table.png', '/products/cocktail-highboy-table.png']),
      stock: 25,
      categoryId: tables.id,
    },
    ...
    // ===== LIGHTING (5) =====
    {
      ...
      images: JSON.stringify(['/products/crystal-chandelier.png', '/products/brass-lantern.png', '/products/gold-floor-lamp.png']),
    ...
    },
    {
      ...
      securityDeposit: 8.0,
      images: JSON.stringify(['/products/led-uplighter.png', '/products/industrial-pendant-light.png', '/products/gold-floor-lamp.png']),
      stock: 60,
      categoryId: lighting.id,
    },
    {
      ...
      images: JSON.stringify(['/products/industrial-pendant-light.png', '/products/gold-floor-lamp.png', '/products/led-uplighter.png']),
      stock: 35,
      categoryId: lighting.id,
    },
    {
      ...
      securityDeposit: 18.0,
      images: JSON.stringify(['/products/brass-lantern.png', '/products/crystal-chandelier.png', '/products/industrial-pendant-light.png']),
      stock: 45,
      categoryId: lighting.id,
    },
    {
      ...
      images: JSON.stringify(['/products/gold-floor-lamp.png', '/products/industrial-pendant-light.png', '/products/brass-lantern.png']),
  ...
  const laLoungeProducts = [
    {
      ...
      rentalPricePerDay: 8,
      securityDeposit: 20,
      images: JSON.stringify(['/products/lalounge_modern.webp', '/products/birthday_atelier.webp']),
      stock: 100,
      isActive: true,
  ...
  const birthdayProducts = [
    {
      ...
      securityDeposit: 100,
      images: JSON.stringify(['/products/birthday_atelier.webp', '/products/lalounge_modern.webp']),
      stock: 20,
      isActive: true,
